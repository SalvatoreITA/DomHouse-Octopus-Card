console.info("%c 🐙 DOMHOUSE OCTOPUS SUITE v1.1 (DYNAMIC RENDER) IS LOADED ", "color: white; background: #ff00ff; font-weight: bold; border: 1px solid white; padding: 2px 6px; border-radius: 4px;");
...
class DomHouseOctopusCard extends LitElement {
  ...
  static getStubConfig() {
    return {
      ...
      tariff_type: "fissa",
      luce_prezzo_tu: "sensor._prezzo_elettricita_f1_o_monoraria",
      luce_pcv_tu: "sensor.a_00000000_quota_fissa_elettricita",
      luce_prezzo_sito: "sensor.octopus_fissa_12m_luce",
      luce_pcv_sito: "sensor.octopus_fissa_commercializzazione_luce",
      gas_prezzo_tu: "sensor.a_00000000_prezzo_gas",
      gas_qvd_tu: "sensor.a_00000000_quota_fissa_gas",
      gas_prezzo_sito: "sensor.octopus_fissa_12m_gas",
      gas_qvd_sito: "sensor.octopus_fissa_commercializzazione_gas",
      extra_luce: "sensor.octopus_flex_mono_luce",
      extra_gas: "sensor.octopus_flex_gas"
    };
  }
  ...
  getSensorValue(entityId, decimals, fallback = 999) {
    if (!entityId || !this.hass || !this.hass.states[entityId]) return { val: fallback, str: '0.0000' };
  ...
  render() {
    ...
    if (hasLuce) {
      ...
      verdettoLuceHtml = html`
        <div style="background: rgba(0,0,0,0.3); padding: 10px; border-radius: 8px; border-left: 4px solid ${colLuce};">
        ...
        <div class="glass-box bordered">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px;">
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 8px; font-weight: bold;">⚡ Prezzo (Є/kWh)</div>
              ...
              <div style="text-align: right; font-size: 11px; font-weight: bold; color: ${color_prezzo_l}; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 6px;">Vince: ${icon_prezzo_l}</div>
            </div>
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 8px; font-weight: bold;">🏢 PCV (Є/anno)</div>
              ...
              <div style="text-align: right; font-size: 11px; font-weight: bold; color: ${color_pcv_l}; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 6px;">Vince: ${icon_pcv_l}</div>
            </div>
          </div>
        </div>
      `;
    ...
    if (hasGas) {
      ...
      verdettoGasHtml = html`
        <div style="background: rgba(0,0,0,0.3); padding: 10px; border-radius: 8px; border-left: 4px solid ${colGas};">
      ...
      gasBox = html`
        <div class="glass-box bordered">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px;">
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 8px; font-weight: bold;">⚡ Prezzo (Є/Smc)</div>
              ...
              <div style="text-align: right; font-size: 11px; font-weight: bold; color: ${color_prezzo_g}; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 6px;">Vince: ${icon_prezzo_g}</div>
            </div>
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 8px; font-weight: bold;">🏢 QVD (Є/anno)</div>
              ...
              <div style="text-align: right; font-size: 11px; font-weight: bold; color: ${color_qvd_g}; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 6px;">Vince: ${icon_qvd_g}</div>
            </div>
          </div>
        </div>
      `;
    ...
    if (hasLuce || hasGas) {
      verdettoBox = html`
        <div class="glass-box bordered">
          <div style="font-size: 16px; font-weight: bold; color: #fff; margin-bottom: 12px; display: flex; align-items: center; gap: 8px;">🏆 Il Verdetto</div>
      ...
      extraBox = html`
        <div class="glass-box extra-box">
           <div style="display: flex; align-items: center; margin-bottom: 10px;">
            <div style="font-size: 14px; font-weight: bold; color: #fff;">${extraTitle}</div>
          </div>
          <div style="display: grid; grid-template-columns: ${gridCols}; gap: 10px; font-size: 13px;">
            ${hasExtraLuce ? html`
              <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px; text-align: center;">
                <div style="color: #aaa; margin-bottom: 5px;">Luce Monoraria</div>
                <div style="font-size: 15px; font-weight: bold;">${extra_l.str} <span style="font-size: 11px; font-weight: normal;">€/kWh</span></div>
              </div>
            ` : html``}
            ${hasExtraGas ? html`
              <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px; text-align: center;">
                <div style="color: #aaa; margin-bottom: 5px;">Gas</div>
                <div style="font-size: 15px; font-weight: bold;">${extra_g.str} <span style="font-size: 11px; font-weight: normal;">€/Smc</span></div>
              </div>
            ` : html``}
          </div>
        </div>
    ...
    return html`
      <ha-card>
        ...
        <div class="main-container" style="${!this._config.title ? 'margin-top: 0;' : ''}">
          ...
          ${verdettoBox}
          ${extraBox}
          ${!hasLuce && !hasGas && !hasExtraLuce && !hasExtraGas ? html`<div style="text-align: center; color: #888;">Nessun sensore configurato. Apri l'editor per iniziare.</div>` : html``}
        </div>
      </ha-card>
    `;
  }
  ...
  static get styles() {
    return css`
      ...
      ha-card { background: linear-gradient(145deg, #1a1a1a, #282828); color: white; border-radius: 20px; padding: 20px; box-sizing: border-box; border: none; box-shadow: none; }
      .card-header-main { font-weight: 800; font-size: 24px; color: #ffffff; padding-bottom: 5px; }
      .main-container { display: flex; flex-direction: column; gap: 20px; margin-top: 20px; }
      .glass-box { background: rgba(255, 255, 255, 0.05); padding: 15px; box-sizing: border-box; }
      .bordered { border-radius: 15px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
  ...
  render() {
    ...
    return html`
      <div class="card-config">
        ...
        <div class="sensor-group"><h4>💡 Sensori Luce (Lascia vuoti se non hai la luce)</h4><div class="vertical-inputs">
        ...
        <div class="sensor-group"><h4>🔥 Sensori Gas (Lascia vuoti se non hai il gas)</h4><div class="vertical-inputs">
        ...
        <div class="sensor-group"><h4>📊 Sensori Riquadro Inferiore (Lascia vuoto quello che non ti serve)</h4><div class="vertical-inputs">
...
class DomHouseMyContractCard extends LitElement {
  ...
  static getStubConfig() {
    return {
      ...
      l_prodotto: "sensor.a_00000000_prodotto_elettrico", l_stato: "sensor.a_00000000_stato_fornitura_elettrica", l_prezzo: "sensor.a_00000000_prezzo_elettricita_f1_o_monoraria", l_pcv: "sensor.a_00000000_quota_fissa_elettricita", l_fine: "sensor.a_00000000_fine_contratto_elettrico", l_giorni: "sensor.a_00000000_giorni_alla_scadenza_contratto_elettrico", l_lettura: "sensor.a_00000000_data_ultima_lettura_elettricita",
      g_prodotto: "sensor.a_00000000_prodotto_gas", g_stato: "sensor.a_00000000_stato_fornitura_gas", g_prezzo: "sensor.a_00000000_prezzo_gas", g_qvd: "sensor.a_00000000_quota_fissa_gas", g_fine: "sensor.a_00000000_fine_contratto_gas", g_giorni: "sensor.a_00000000_giorni_alla_scadenza_contratto_gas", g_lettura: "sensor.a_00000000_data_ultima_lettura_gas"
    };
  }
  ...
  getNumberValue(entityId, decimals, fallbackStr = '0.0') {
  ...
  render() {
    ...
    if (hasLuce) {
      ...
      const l_prezzo = this.getNumberValue(this._config.l_prezzo, 4, '0.0000');
      const l_pcv = this.getNumberValue(this._config.l_pcv, 1, '0.0');
      ...
      luceBox = html`
        <div class="glass-box bordered">
          <div class="flex-header" style="border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px; margin-bottom: 15px;">
            <div style="font-size: 18px; font-weight: bold; color: #00d1ff;">💡 ENERGIA ELETTRICA</div>
            <div class="status-badge" style="border: 1px solid ${l_statoColor}; color: ${l_statoColor};">${l_textStato}</div>
          </div>
          <div style="font-size: 14px; margin-bottom: 15px;"><span style="color: #aaa;">Prodotto:</span> <b>${l_prod}</b></div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px;">
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 5px;">💰 Costi Attuali</div><div>Energia: <b>${l_prezzo} €/kWh</b></div><div>PCV: <b>${l_pcv} €/anno</b></div>
            </div>
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 5px;">📅 Scadenze</div><div>Fine: <b>${l_fine}</b></div><div style="color: ${l_giorniColor}; font-weight: bold;">Tra ${l_giorni} giorni</div>
            </div>
          </div>
          <div style="margin-top: 15px; font-size: 11px; color: #888; text-align: right;">Ultima lettura: ${l_lettura}</div>
        </div>
      `;
    }
    ...
    if (hasGas) {
      ...
      const g_prezzo = this.getNumberValue(this._config.g_prezzo, 4, '0.0000');
      const g_qvd = this.getNumberValue(this._config.g_qvd, 1, '0.0');
      ...
      gasBox = html`
        <div class="glass-box bordered">
          <div class="flex-header" style="border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px; margin-bottom: 15px;">
            <div style="font-size: 18px; font-weight: bold; color: #ff9800;">🔥 GAS NATURALE</div>
            <div class="status-badge" style="border: 1px solid ${g_statoColor}; color: ${g_statoColor};">${g_textStato}</div>
          </div>
          <div style="font-size: 14px; margin-bottom: 15px;"><span style="color: #aaa;">Prodotto:</span> <b>${g_prod}</b></div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px;">
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 5px;">💰 Costi Attuali</div><div>Materia: <b>${g_prezzo} €/Smc</b></div><div>QVD: <b>${g_qvd} €/anno</b></div>
            </div>
            <div style="background: rgba(0,0,0,0.2); padding: 10px; border-radius: 10px;">
              <div style="color: #aaa; margin-bottom: 5px;">📅 Scadenze</div><div>Fine: <b>${g_fine}</b></div><div style="color: ${g_giorniColor}; font-weight: bold;">Tra ${g_giorni} giorni</div>
            </div>
          </div>
          <div style="margin-top: 15px; font-size: 11px; color: #888; text-align: right;">Ultima lettura: ${g_lettura}</div>
        </div>
      `;
    }
    ...
    return html`
      <ha-card>
        ...
        <div class="main-grid" style="${!this._config.title ? 'margin-top: 0;' : ''}">
          ${luceBox}
          ${gasBox}
          ${!hasLuce && !hasGas ? html`<div style="text-align: center; color: #888;">Nessun sensore configurato. Apri l'editor per iniziare.</div>` : html``}
        </div>
      </ha-card>
    `;
  }
  ...
  static get styles() {
    return css`
      :host { display: block; font-family: var(--primary-font-family, sans-serif); }
      ha-card { background: linear-gradient(145deg, #1a1a1a, #282828); color: white; border-radius: 20px; padding: 20px; box-sizing: border-box; border: none; box-shadow: none; }
      .card-title { font-weight: 800; font-size: 24px; color: #ffffff; padding-bottom: 5px; }
      .main-grid { display: flex; flex-direction: column; gap: 20px; margin-top: 20px; }
      .glass-box { background: rgba(255, 255, 255, 0.05); padding: 15px; box-sizing: border-box; }
      .bordered { border-radius: 15px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
      .flex-header { display: flex; justify-content: space-between; align-items: center; }
      .status-badge { font-size: 12px; font-weight: bold; background: rgba(0,0,0,0.4); padding: 4px 10px; border-radius: 10px; }
      div { box-sizing: border-box; }
    `;
  }
}
  ...
  render() {
    ...
    return html`
      <div class="card-config">
        ...
        <div class="sensor-group"><h4>💡 Sensori Luce (Lascia vuoti se non li hai)</h4><div class="vertical-inputs">
        ...
        <div class="sensor-group"><h4>🔥 Sensori Gas (Lascia vuoti se non li hai)</h4><div class="vertical-inputs">
