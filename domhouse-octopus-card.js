console.info("%c 🐙 DOMHOUSE OCTOPUS SUITE v1.4 (THEME SELECTOR) IS LOADED ", "color: white; background: #ff00ff; font-weight: bold; border: 1px solid white; padding: 2px 6px; border-radius: 4px;");
